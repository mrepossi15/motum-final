...
<div class="relative ">
    ...
    <div class="flex flex-wrap gap-2  ">
        @foreach ($options as $value => $label)
            <label class="flex items-center border border-gray-500 hover:border-orange-500 rounded-md px-4 py-3 focus-within:ring-2 focus-within:ring-orange-500 focus-within:border-orange-500
                ...
                <input
                    ...
                    class="h-4 w-4 text-orange-500 bg-gray-50 focus:ring-orange-500"
                >
